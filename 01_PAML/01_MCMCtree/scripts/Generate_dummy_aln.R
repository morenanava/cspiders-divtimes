...
# LOAD OBJECTS #
#--------------#
# While there are three dataset, it does not matter which tree is use.
# We only need a dummy dataset as the same taxa are used in the three datasets!
tt <- ape::read.tree( file = "../../00_data_formatting/01_inp_data/tree_noeurycyde_uncalib.tree" )
