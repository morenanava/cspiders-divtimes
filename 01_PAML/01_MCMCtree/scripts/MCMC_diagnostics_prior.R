...
path          <- path_prior
num_divt      <- num_divt
node_calib    <- calib_nodes # There are 3 matrices!
dataset       <- dat
perc          <- perc
...
## [[ CLK - noeurycyde ]] ####
sum_prior_QC$noeurycyde$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 120006    217
length( sum_prior_QC$noeurycyde$not_conv_nodes ) # 0
sum_prior_QC$noeurycyde$num_chains # 6

# [[ CLK - noUCEs ]] ####
sum_prior_QC$noUCEs$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 120006    217
length( sum_prior_QC$noUCEs$not_conv_nodes ) # 0
sum_prior_QC$noUCEs$num_chains # 6

# [[ CLK - supaln ]] ####
sum_prior_QC$supaln$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 120006    217
length( sum_prior_QC$supaln$not_conv_nodes ) # 0
sum_prior_QC$supaln$num_chains # 6
