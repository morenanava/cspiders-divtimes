...
# In this case, the number of lines is 120006 for the three datasets, and so
# we just need to specify one number less.
#
# NOTE: If you had more than one dataset with different values, you would add
# another number to the `def_samples` vector.
# E.g. three datasts: c( 120005, 120005, 60003 )
def_samples <- 120005
...
# --> When one alignment block, there is 1 `mu`
